      ...
      <div className="px-6 flex flex-col gap-6">
        ...
        <div className="grid grid-cols-2 gap-3 mt-2">
          ...
          <button
            ...
            className="w-full bg-[#E05A4F] text-white py-4 rounded-2xl font-bold shadow-lg shadow-red-200 hover:bg-[#d6453a] transition-all active:scale-[0.98] flex flex-col items-center justify-center gap-1">
