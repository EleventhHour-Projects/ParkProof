...
const LoginPage = () => {
    ...
    return (
        <div className="min-h-screen w-full bg-[url('/user-login.png')] bg-cover bg-center bg-no-repeat flex flex-col items-center justify-between py-10 px-4 relative overflow-hidden font-sans">
            ...
            {/* Header Section */}
            <div className="w-full max-w-md flex flex-col items-start z-10 pt-10 pl-3">
            ...
            {/* Login Card */}
            <div className="w-full max-w-md bg-white rounded-[2rem] p-8 shadow-2xl z-10 mt-16">
            ...
            {/* Footer */}
            <div className="mt-auto pt-10 flex flex-col items-center z-10 w-full mb-6">
                <div className="flex items-center justify-center gap-4 mb-2 opacity-90">
                    ...
                    />
                    <div className="h-8 w-px bg-white/40 rounded-full" />
                    <Image
